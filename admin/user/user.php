...
$query = "SELECT id_user, username, email FROM user ORDER BY id_user DESC";
...
<body>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-people-fill me-2"></i>Data User</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="reset_password.php?id=<?= $row['id_user'] ?>" class="btn btn-sm btn-info">
                                    <i class="bi bi-key"></i>
                                </a>
                                <a href="hapus_user.php?id=<?= $row['id_user'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus?')">
